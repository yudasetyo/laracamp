                            ...
                            <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($errors->has('occupation'))
                                        <p class="text-danger"><strong>{{ $errors->first('occupation') }}</strong></p>
                                    @endif
                                </div>
                                <div class="mb-4">
                                    ...
                                    @if ($errors->has('card_number'))
                                        <p class="text-danger"><strong>{{ $errors->first('card_number') }}</strong></p>
                                    @endif
                                </div>
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            @if ($errors->has('expired'))
                                                <p class="text-danger"><strong>{{ $errors->first('expired') }}</strong></p>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            ...
                                            @if ($errors->has('cvc'))
                                                <p class="text-danger"><strong>{{ $errors->first('cvc') }}</strong></p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
